...
def add_data(unique):
        ...
        while True: 
                ...
                if new_car_year.isnumeric():
                        ...
                        if new_car_year <= 2023:
                                break
                        else:
                                print('Car Manufacture Year should be Less Than or Equal to 2023\nPlease Input Again')
                else:
...
def rent_proceed(tgt_idx,choosen_car,origin_idx):
        while True:
                ...
                if cnt.isalpha():
                        if cnt == 'Yes':
                                total_days(tgt_idx,choosen_car,origin_idx)
                                break
                        elif cnt == 'No':
                                break
                        else:
...
def total_days(tgt_idx,choosen_car,origin_idx):
        while True:
